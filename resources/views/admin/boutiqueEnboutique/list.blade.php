...
@section('content')
    <h1>{{ $boutique->nom }}</h1>
    <div class="mb-3">
        <a href="{{ url('admin/boutique/' . $nom.'/operation') }}" class="btn btn-dark">
            Retour
        </a>
        @if (Auth::user()->role_as == '1')
            <a href="{{ url('admin/boutique/'.$nom.'/operation/'.$nomBoutique.'/create') }}" class="btn btn-dark">
                Ajouter une Operation
            </a>
        @endif
        <a href="{{ url('admin/boutique/'.$nom.'/operation/'.$nomBoutique.'/historique') }}" class="btn btn-dark">
            Historiques
        </a>
    </div>
