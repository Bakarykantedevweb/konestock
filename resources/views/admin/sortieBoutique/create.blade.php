...
@section('content')
    <h1>{{ $boutique->nom }} et {{ $nomMagasin }}</h1>
    @include('layouts.partials.error')
    <div class="mb-3">
        <a href="{{ url('admin/boutique/'.$boutique->nom.'/sortie/'.$nomMagasin) }}" class="btn btn-dark">
            Retour
        </a>
    </div>
    <div class="row">
        <div class="col-lg-12 col-xlg-9 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ url('admin/boutique/'.$boutique->nom.'/sortie/'.$nomMagasin.'/create') }}"
