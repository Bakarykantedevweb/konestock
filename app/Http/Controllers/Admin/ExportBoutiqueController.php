...
class ExportBoutiqueController extends Controller
{
    public function export($nomBoutique)
    {
        ...
        $productData = Produit::where('boutique_id', $boutique->id)
        ...
        header('Content-Disposition: attachment;filename="produitsBoutiques.xlsx"');
